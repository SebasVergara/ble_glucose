...
/* harmony import */ var _config_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./config-routing.module */ "./src/app/config/config-routing.module.ts");
...
let ConfigPage = class ConfigPage {
    constructor(ble, ngzone, toastController, storage, router) {
        this.ble = ble;
        this.ngzone = ngzone;
